...
Personal reference: everything built, organized by category. Not a CV — a full accounting of repos, tech, and scale. Last updated: March 2026
--------------------------------------------------------------------------------
Table of Contents
Production / Shipped
...
University Lab Work (UP iOS Lab)
Academic / Coursework
Tiny / Experiments
CV Cross-Reference
--------------------------------------------------------------------------------
...
Status: Shipped (Oct 2025 – Mar 2026) Repo: legalTech/ (monorepo: backend, frontend, mobile)
...
Integrations: PayPal (Orders, Vault, Subscriptions, Webhooks), Google Workspace/Meet API (event lifecycle, video ETL), Twilio SMS, SendGrid, RENAPO/CURP Puppeteer scrapers, SEP Cédula validation. Infra: Terraform IaC on GCP, GitHub Actions CI/CD → Cloud Run (staging + production), PostgreSQL, Redis. Stack: TypeScript, Node.js, Express, React Native, Expo, Next.js, Firebase, GCP, Redis, BullMQ, Terraform, Docker, Prometheus
--------------------------------------------------------------------------------
Photo Portfolio — jrmgraphy.com
Status: Live at jrmgraphy.com Repo: Photo-Portfolio/ | GitHub: JavierRangel2004/Photo-Portfolio
...
Status: Deployed for live organization Repo: oscWEBFINAL/ | GitHub: JavierRangel2004/redes-que-cambian
...
Status: Built and sold to a consultancy Repo: GitHub: JavierRangel2004/sustentabilidad (not local)
...
Status: Active, deployed on Cloudflare Repo: GPSpei/
...
Status: Active, self-hosted Repo: Notadio/ | GitHub: JavierRangel2004/Notadio
...
Status: Active Repo: PhotoCat/ | GitHub: JavierRangel2004/PhotoCat
...
Status: Completed Repo: backwell-api/
...
Status: Active, self-hosted Repo: clawBotJRM/
...
Status: Deployed at university Repo: GitHub: JavierRangel2004/Wayfinder (not local)
...
--------------------------------------------------------------------------------
discordBot
Status: Completed Repo: discordBot/
...
--------------------------------------------------------------------------------
Visionwire-Back
Status: Completed Repo: Visionwire-Back/
...
Status: Course project (capstone shipped) Repo: Natural-Language-Processing-course/
...
Status: Completed Repo: logisticsProject/
...
Status: Completed (academic) Repo: ecuDifProyect/
...
Status: Coursework Repo: Artificial-Inteligence/
...
Status: Completed (academic) Repo: IA_ProyectoSegundoParcial/
...
--------------------------------------------------------------------------------
photoCategorizer
Status: Empty/archived Repo: photoCategorizer/ (predecessor to PhotoCat)
--------------------------------------------------------------------------------
4. Systems & Low-Level
D-OS — RISC-V OS Kernel + DOOM
Status: Completed (academic) Repo: D-OS/
...
Status: Completed (academic) Repo: compiladoresUP/
...
Status: Completed (academic) Repo: arqCompAsmProject/
...
Status: Completed (academic) Repo: ProyectoFinal/
...
Status: Coursework (large-scale) Repo: DatosMasivos/
...
Status: Completed Repo: MexicoHotels-Data/
...
Status: Coursework Repo: MLCourseUP/
...
Status: Coursework Repos: BusinessDataScience/, Data-scienceBusiness/
...
Status: Production-ready Repo: branch_ios/
...
--------------------------------------------------------------------------------
upocket-apiC
Status: Completed Repo: upocket-apiC/
...
--------------------------------------------------------------------------------
IOS-SocialMeida
Status: Completed (educational) Repo: IOS-SocialMeida/
...
--------------------------------------------------------------------------------
classtime-matcher
Status: Completed Repo: classtime-matcher/
...
Status: Active (teaching) Repo: uspaces/
...
JStorage — Spring Boot Inventory Service
Status: Completed (educational) Repo: JStorage/
Complete implementation of a Spring Boot inventory service (Java 17). Features JPA entities, Flyway migrations, PostgreSQL (via Docker Compose), transactional stock movement/reservation logic with optimistic locking, and a full REST API with Postman test suites. Emphasizes clean domain modeling and teachable architecture.
Stack: Java 17, Spring Boot, Spring Data JPA, PostgreSQL, H2, Flyway, Docker Compose
--------------------------------------------------------------------------------
DB_Avanzadas — Database Replication
Status: Completed (academic) Repo: DB_Avanzadas/
...
--------------------------------------------------------------------------------
Pok-Hub
Status: Completed (learning) Repo: Pok-Hub/
...
--------------------------------------------------------------------------------
POKEDEX
Status: Completed (JS kata) Repo: POKEDEX/
...
Status: Archived (replaced by Photo-Portfolio) Repo: Front_Workshop/
...
Status: Archived (early prototype) Repo: Photography-Portfolio/
...
Python
DBs
Datasets (Harry Potter chars, CDMX Metro, carpetas 2022)
CSV, Jupyter
ecuDifProyect
See Section 3
Python
...
Python
git_2, hola, mi_entorno
Throwaway experiments
Various
whisper.cpp
whisper.cpp local clone/build
C++
ProgramaTesting
C++ binary data testing
C++
sqlTest
SQL triggers/queries testing and explanations
SQL
Compiladores
Flex and Bison cheatsheets, guides, and small lex examples
C, Flex, Bison, Markdown
--------------------------------------------------------------------------------
9. CV Cross-Reference
Currently in CV ✓
CV Entry
Repo
LegalTec — Founding Backend & Mobile Engineer
legalTech/
UP iOS Lab — Backend Development Lead
branch_ios/, uspaces/, etc.
UP iOS Lab — Backend Developer
IOS-SocialMeida/, upocket-apiC/, etc.
Notadio
Notadio/
PhotoCat
PhotoCat/
